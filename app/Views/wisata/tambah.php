                ...
                <table class="contributor-container" style="width: 50%; margin:auto;" >
                    <tr>
                        <td>
                            ...
                            <input type="text" name="namatempat" id="namatempat" style="width:100%; height:2rem; padding:0.3rem" required autofocus>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="text" name="provinsi" id="provinsi" style="width:100%; height:2rem; padding:0.3rem" required>
                        </td>
                    </tr>
                    <tr>
                        <td>
